let assistant;
async function getAssistant(){return assistant??=import('./mascot.js?v=original-paper-18-studio-grounded').catch(error=>{assistant=null;document.querySelector('.ai-mascot-toggle__label').textContent='Assistant unavailable · retry';throw error;});}
