let assistant;
async function getAssistant(){return assistant??=import('./mascot.js?v=paper-mobile-detail-1').catch(error=>{assistant=null;document.querySelector('.ai-mascot-toggle__label').textContent='Assistant unavailable · retry';throw error;});}
